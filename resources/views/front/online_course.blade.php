...
<!-- Content Wrapper. Contains page content -->
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a class="btn btn-success btn-sm" href="" data-toggle="modal" data-target="#exampleModal">Add Online Course</a>
</div>
              </div>
              <div class="card-body">
                ...
                @foreach($dis as $key=>$d)
                    ...
                    <tr class="text-center">
                      ...
                      <td scope="col">
                          ...
                          <a href="{{url('front/online_course_edit/'.$d->id)}}"><input class="btn btn-success" type="submit" name="edit" value="Edit" style="width: 70px;"></a><br><br>
                          <a href="{{url('front/deletee/'.$d->id)}}"><input class="btn btn-danger" type="submit" name="delete" value="Delete"></a>
 ...
 <span aria-hidden="true">&times;</span>
  ...
  @endif
        ...
        <form  method="post" action="{{url('front/insert')}}" enctype="multipart/form-data">
